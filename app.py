...
def show_venue(venue_id):
    ...
    if db.session.query(Venue.id).first() is not None:
        ...
        shows_past = Show.query.filter_by(venue_id=venue_id).filter(Show.start_time < datetime.now()).all()
...
def create_venue_submission():
    ...
    # odify data to be the data object returned from db insertion
...
def create_artist_submission():
    ...
    try:
        artist = Artist(name=form.name.data, city=form.city.data, state=form.state.data, phone=form.phone.data,
                        ...
                        website_link=form.website_link.data, looking_venues=form.seeking_venue.data,
                        seeking_description=form.seeking_description.data, genres=form.genres.data)
